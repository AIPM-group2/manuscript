...
export const generalRules = [
  ...
  new FormattingRule(
    ...
    true,
    false
  ), // Guideline 12 - UNSAFE (Manual input needed)
  ...
  new FormattingRule(
    ...
    true,
    false
  ), // Guideline 13 - UNSAFE (Manual input needed)
  ...
  new FormattingRule(
    ...
    true,
    false
  ), // Guideline 14 - UNSAFE (Manual input needed)
  ...
  new FormattingRule(
    ...
    true,
    true
  ), // Guideline 15 - SAFE (Adding section block)
  ...
  new FormattingRule(
    ...
    true,
    true
  ), // Guideline 16 - SAFE (Moving section)
  ...
  new FormattingRule(
    ...
    true,
    false
  ), // Guideline 17 - UNSAFE (Risk of missed redacted info)
  ...
  new FormattingRule(
    ...
    true,
    false
  ), // Guideline 18 - UNSAFE (Generating keywords)
